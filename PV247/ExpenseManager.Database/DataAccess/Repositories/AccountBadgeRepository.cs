...
namespace ExpenseManager.Database.DataAccess.Repositories
{
    ...
    /// </summary>
    public class AccountBadgeRepository : ExpenseManagerRepository<AccountBadge, UserBadgeDTO, int>
    {
        /// <summary>
        /// Create repository.
        /// </summary>
        ...
        public AccountBadgeRepository(IUnitOfWorkProvider provider, Mapper mapper) : base(provider, mapper) { }
    }
}

...
namespace ExpenseManager.Business.Services.Interfaces
{
    ...
    public interface ICostInfoService : IService
    {
        ...
        List<CostInfo> ListCostInfos(IList<IFilter<CostInfo>> filters, PageAndOrderFilter pageAndOrder);
        ...
        /// Used for pagination
        /// </summary>
        int GetCostInfosCount(IList<IFilter<CostInfo>> filters, PageAndOrderFilter pageAndOrder);
